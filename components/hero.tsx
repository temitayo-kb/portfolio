...
//   return (
//     <section className="flex min-h-[46vh] items-center justify-center px-6 md:px-12 lg:px-24">
...
//           delay={150}
//         >
//           <h1 className="text-1xl font-bold leading-tight tracking-tight text-foreground md:text-3xl">
//             {"Hi, I'm Temitayo. "}
//             <span>{"I'm a "}</span>
//             <span className="text-primary">
//               {"Frontend Software Developer."}
//             </span>{" "}
//             <span className="ml-1 inline-flex -translate-y-0.5 items-center gap-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-2.5 py-0.5 align-middle text-[11px] font-medium text-emerald-400">
